...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/51965208963?text=Hola%2C%20vi%20tu%20p%C3%A1gina%20web%20y%20me%20interesa%20saber%20m%C3%A1s."
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-4 py-3 rounded-full shadow-lg transition-all duration-300 ease-in-out hover:scale-105"
    ...
    >
      ...
      <span className="hidden sm:inline">+51 965 208 963</span>
    </a>
